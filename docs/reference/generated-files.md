...
| `.opencode/plugins/opencode-plusplus.ts`                                                                 | Yes                                | Usually yes for OpenCode sidecar mode                                     | Low; imports local OpenCode++ runtime                              | `opencode-plusplus` or `opencode-plusplus tui . --force-plugin`      |
