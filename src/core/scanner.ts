...
import type { RepoContextConfig, RepoFile, RepoScan } from "./types.js";
...
export async function scanRepository(root: string, config: RepoContextConfig): Promise<RepoScan> {
