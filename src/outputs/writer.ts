...
function isGeneratedAgentFile(content: string): boolean {
  return (
    content.includes("generated-by: code-agent-plusplus") ||
    content.includes("generated-by: repo-to-agent-context") ||
    content.includes("This file was generated by Code Agent++") ||
