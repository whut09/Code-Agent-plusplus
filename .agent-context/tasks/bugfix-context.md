...
Type: bugfix
Budget: 7,552 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 373 | direct importer of src/harness/verification-plane/guards/regression.ts, direct importer of src/harness/verification-plane/guards/regression-memory.ts, entrypoint | src/cli/index.ts contains 120 detected symbols, 35 imports, 0 exports. |
...
Remaining budget: 4,448 estimated tokens
