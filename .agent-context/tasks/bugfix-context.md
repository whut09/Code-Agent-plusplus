...
Type: bugfix
Budget: 7,608 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 429 | direct importer of src/harness/verification-plane/guards/regression.ts, direct importer of src/harness/verification-plane/guards/regression-memory.ts, entrypoint | src/cli/index.ts contains 133 detected symbols, 37 imports, 0 exports. |
...
| Entrypoints | 834 | `src/cli/index.ts`, `src/mcp/server.ts` |

Remaining budget: 4,392 estimated tokens
