...
Type: bugfix
Budget: 8,342 / 12,000 estimated tokens
...
- `src/integrations/opencode/sidecar.ts` - lexical match: regression, direct importer of src/harness/verification-plane/guards/regression.ts
...
| `src/cli/index.ts` | entrypoint | 451 | direct importer of src/harness/verification-plane/guards/regression.ts, direct importer of src/harness/verification-plane/guards/regression-memory.ts, entrypoint | src/cli/index.ts contains 142 detected symbols, 39 imports, 0 exports. |
| `src/mcp/server.ts` | entrypoint | 403 | entrypoint | src/mcp/server.ts contains 102 detected symbols, 19 imports, 4 exports. |
...
| `src/integrations/opencode/sidecar.ts` | dependency-neighbor | 715 | lexical match: regression, direct importer of src/harness/verification-plane/guards/regression.ts | src/integrations/opencode/sidecar.ts contains 137 detected symbols, 15 imports, 18 exports. |
...
| `opencode-plusplus.config.yml` | config-doc | 37 | configuration | opencode-plusplus.config.yml is a config file written as YAML. |
