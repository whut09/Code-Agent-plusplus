...
Type: bugfix
Budget: 4,673 / 12,000 estimated tokens
...
3. `src/mcp/server.ts` - direct importer of src/outputs/task-harness.ts, direct importer of src/outputs/test-selector.ts; defines codeAgentPlusplusMcpToolNames
...
| `src/mcp/server.ts` | entrypoint | 339 | direct importer of src/outputs/task-harness.ts, direct importer of src/outputs/test-selector.ts, entrypoint | src/mcp/server.ts contains 81 detected symbols, 18 imports, 4 exports. |
| `src/cli/index.ts` | entrypoint | 302 | direct importer of src/outputs/test-selector.ts, direct importer of src/outputs/task-harness.ts, entrypoint | src/cli/index.ts contains 99 detected symbols, 30 imports, 0 exports. |
...
| `src/outputs/task-run.ts` | dependency-neighbor | 200 | direct importer of src/outputs/task-harness.ts, direct importer of src/outputs/test-selector.ts | src/outputs/task-run.ts contains 42 detected symbols, 10 imports, 4 exports. |
| `src/core/types.ts` | dependency-neighbor | 300 | direct dependency of src/outputs/task-harness.ts, direct dependency of src/outputs/test-selector.ts | src/core/types.ts contains 35 detected symbols, 0 imports, 35 exports. |
...
| `src/outputs/policy-engine.ts` | dependency-neighbor | 268 | direct importer of src/outputs/test-selector.ts | src/outputs/policy-engine.ts contains 47 detected symbols, 10 imports, 9 exports. |
...
| `src/outputs/orchestrator.ts` | dependency-neighbor | 519 | direct importer of src/outputs/task-harness.ts | src/outputs/orchestrator.ts contains 111 detected symbols, 17 imports, 11 exports. |
...
| Dependency neighbors | 2,766 | `src/outputs/task-run.ts`, `src/core/types.ts`, `src/outputs/markdown.ts`, `src/core/git.ts`, `src/outputs/policy-engine.ts`, `src/outputs/loop-controller.ts`, `src/outputs/orchestrator.ts`, `src/benchmarks/benchmark.ts`, `src/outputs/contract-validator.ts`, `src/outputs/task-context.ts` |
...
Remaining budget: 7,327 estimated tokens
