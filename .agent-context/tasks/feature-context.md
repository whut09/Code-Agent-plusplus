...
Type: feature
Budget: 3,181 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 281 | direct importer of src/benchmarks/benchmark.ts, entrypoint | src/cli/index.ts contains 93 detected symbols, 29 imports, 0 exports. |
...
Remaining budget: 8,819 estimated tokens
