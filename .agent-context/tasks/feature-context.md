...
Type: feature
Budget: 7,486 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 418 | direct importer of src/benchmarks/benchmark.ts, direct importer of src/benchmarks/agent-benchmark.ts, entrypoint | src/cli/index.ts contains 130 detected symbols, 35 imports, 0 exports. |
...
Remaining budget: 4,514 estimated tokens
