...
Type: feature
Budget: 7,511 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 442 | direct importer of src/benchmarks/benchmark.ts, direct importer of src/benchmarks/agent-benchmark.ts, entrypoint | src/cli/index.ts contains 139 detected symbols, 39 imports, 0 exports. |
