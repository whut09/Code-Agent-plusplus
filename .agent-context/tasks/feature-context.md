...
Type: feature
Budget: 6,851 / 12,000 estimated tokens
...
| `src/outputs/orchestrator.ts` | dependency-neighbor | 522 | direct dependency of src/benchmarks/agent-benchmark.ts | src/outputs/orchestrator.ts contains 112 detected symbols, 18 imports, 11 exports. |
...
Remaining budget: 5,149 estimated tokens
