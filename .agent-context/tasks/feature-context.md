...
Type: feature
Budget: 2,760 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 215 | entrypoint, key file fallback | src/cli/index.ts contains 72 detected symbols, 27 imports, 0 exports. |
...
Remaining budget: 9,240 estimated tokens
