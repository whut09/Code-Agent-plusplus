...
Type: feature
Budget: 7,158 / 12,000 estimated tokens
...
| `src/benchmarks/benchmark.ts` | direct-source | 468 | lexical match: behavior, direct dependency of src/benchmarks/agent-benchmark.ts | src/benchmarks/benchmark.ts contains 93 detected symbols, 7 imports, 11 exports. |
...
| Bucket | Tokens | Files |
| --- | --- | --- |
| Directly relevant source files | 934 | `src/benchmarks/agent-benchmark.ts`, `src/benchmarks/benchmark.ts` |
...
Remaining budget: 4,842 estimated tokens
