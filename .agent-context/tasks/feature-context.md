...
Type: feature
Budget: 3,148 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 248 | direct importer of src/benchmarks/benchmark.ts, entrypoint | src/cli/index.ts contains 83 detected symbols, 28 imports, 0 exports. |
...
Remaining budget: 8,852 estimated tokens
