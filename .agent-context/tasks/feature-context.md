...
Type: feature
Budget: 7,517 / 12,000 estimated tokens
...
4. `src/mcp/server.ts` - entrypoint; defines opencodePlusplusMcpToolNames
...
| `src/cli/index.ts` | entrypoint | 451 | direct importer of src/benchmarks/benchmark.ts, direct importer of src/benchmarks/agent-benchmark.ts, entrypoint | src/cli/index.ts contains 142 detected symbols, 39 imports, 0 exports. |
...
| `src/core/safe-command.ts` | dependency-neighbor | 159 | direct dependency of src/benchmarks/agent-benchmark.ts | src/core/safe-command.ts contains 26 detected symbols, 1 import, 5 exports. |
