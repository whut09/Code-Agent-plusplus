...
Type: feature
Budget: 3,165 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 265 | direct importer of src/benchmarks/benchmark.ts, entrypoint | src/cli/index.ts contains 88 detected symbols, 28 imports, 0 exports. |
...
Remaining budget: 8,835 estimated tokens
