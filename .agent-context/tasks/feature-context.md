...
Type: feature
Budget: 2,781 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 210 | entrypoint, key file fallback | src/cli/index.ts contains 70 detected symbols, 26 imports, 0 exports. |
...
Remaining budget: 9,219 estimated tokens
