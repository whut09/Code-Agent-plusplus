...
Type: refactor
Budget: 11,981 / 12,000 estimated tokens
...
| `test/orchestrator.test.ts` | test | 86 | shared API/refactor risk | test/orchestrator.test.ts contains 17 detected symbols, 8 imports, 0 exports. |
...
| `src/outputs/orchestrator.ts` | dependency-neighbor | 484 | lexical match: code, direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/orchestrator.ts contains 103 detected symbols, 15 imports, 11 exports. |
| `src/outputs/execution-trace.ts` | dependency-neighbor | 330 | lexical match: code, direct dependency of src/mcp/server.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/execution-trace.ts contains 49 detected symbols, 6 imports, 19 exports. |
...
| `src/outputs/task-run.ts` | dependency-neighbor | 200 | direct dependency of src/mcp/server.ts, direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/task-run.ts contains 42 detected symbols, 10 imports, 4 exports. |
