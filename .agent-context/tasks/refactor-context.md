...
Type: refactor
Budget: 2,986 / 12,000 estimated tokens
...
| `src/outputs/agents-md.ts` | 28 | caller/importer of src/outputs/markdown.ts | src/outputs/agents-md.ts contains 26 detected symbols, 3 imports, 1 export. |
...
| `src/core/types.ts` | 18 | shared API/refactor risk | src/core/types.ts contains 30 detected symbols, 0 imports, 30 exports. |
...
| `src/config/load-config.ts` | 18 | shared API/refactor risk | src/config/load-config.ts contains 29 detected symbols, 5 imports, 2 exports. |
...
| `test/config.test.ts` | 18 | shared API/refactor risk | test/config.test.ts contains 7 detected symbols, 7 imports, 0 exports. |
