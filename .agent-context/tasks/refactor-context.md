...
| `src/cli/index.ts` | entrypoint | 313 | lexical match: code, direct importer of src/integrations/codegraph.ts, entrypoint, shared API/refactor risk | src/cli/index.ts contains 103 detected symbols, 32 imports, 0 exports. |
