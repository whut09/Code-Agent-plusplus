...
Type: refactor
Budget: 9,222 / 12,000 estimated tokens
...
| `src/cli/index.ts` | entrypoint | 210 | direct importer of src/core/token-estimator.ts, entrypoint, shared API/refactor risk | src/cli/index.ts contains 70 detected symbols, 26 imports, 0 exports. |
...
| Entrypoints | 436 | `src/cli/index.ts`, `src/mcp/server.ts` |

Remaining budget: 2,778 estimated tokens
