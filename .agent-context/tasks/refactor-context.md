...
6. `src/outputs/markdown.ts` - lexical match: code, shared API/refactor risk; defines heading
...
| `src/cli/index.ts` | entrypoint | 288 | direct importer of src/core/types.ts, entrypoint, shared API/refactor risk | src/cli/index.ts contains 95 detected symbols, 29 imports, 0 exports. |
...
| `test/execution-trace.test.ts` | test | 78 | shared API/refactor risk | test/execution-trace.test.ts contains 15 detected symbols, 9 imports, 0 exports. |
...
| `test/orchestrator.test.ts` | test | 67 | shared API/refactor risk | test/orchestrator.test.ts contains 9 detected symbols, 8 imports, 0 exports. |
...
| `src/outputs/context-delta.ts` | dependency-neighbor | 304 | lexical match: code, direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/context-delta.ts contains 66 detected symbols, 5 imports, 9 exports. |
| `src/outputs/orchestrator.ts` | dependency-neighbor | 366 | lexical match: code, direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/orchestrator.ts contains 77 detected symbols, 15 imports, 9 exports. |
| `src/outputs/execution-trace.ts` | dependency-neighbor | 332 | lexical match: code, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/execution-trace.ts contains 50 detected symbols, 5 imports, 19 exports. |
...
| `src/outputs/task-harness.ts` | dependency-neighbor | 277 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/task-harness.ts contains 67 detected symbols, 7 imports, 5 exports. |
| `src/outputs/task-run.ts` | dependency-neighbor | 199 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/task-run.ts contains 42 detected symbols, 10 imports, 4 exports. |
| `src/outputs/loop-controller.ts` | dependency-neighbor | 302 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/loop-controller.ts contains 60 detected symbols, 13 imports, 10 exports. |
| `src/outputs/policy-engine.ts` | dependency-neighbor | 255 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/policy-engine.ts contains 45 detected symbols, 9 imports, 9 exports. |
| `src/outputs/impact.ts` | dependency-neighbor | 230 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/impact.ts contains 46 detected symbols, 3 imports, 4 exports. |
| `src/outputs/test-selector.ts` | dependency-neighbor | 226 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/test-selector.ts contains 44 detected symbols, 3 imports, 4 exports. |
| `src/retrievers/index.ts` | dependency-neighbor | 88 | direct dependency of src/mcp/server.ts, direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/retrievers/index.ts contains 2 detected symbols, 7 imports, 6 exports. |
| `src/outputs/task-context.ts` | dependency-neighbor | 252 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, direct dependency of src/mcp/server.ts | src/outputs/task-context.ts contains 64 detected symbols, 3 imports, 3 exports. |
| `src/core/freshness.ts` | dependency-neighbor | 290 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/core/freshness.ts contains 57 detected symbols, 8 imports, 9 exports. |
| `src/outputs/contract-validator.ts` | dependency-neighbor | 327 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/contract-validator.ts contains 65 detected symbols, 6 imports, 5 exports. |
| `src/benchmarks/benchmark.ts` | dependency-neighbor | 452 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/benchmarks/benchmark.ts contains 90 detected symbols, 7 imports, 11 exports. |
| `src/outputs/rag.ts` | dependency-neighbor | 113 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/rag.ts contains 15 detected symbols, 3 imports, 4 exports. |
...
| `src/outputs/writer.ts` | dependency-neighbor | 246 | direct importer of src/core/types.ts, direct dependency of src/mcp/server.ts, shared API/refactor risk | src/outputs/writer.ts contains 55 detected symbols, 18 imports, 2 exports. |
| `src/outputs/architecture.ts` | dependency-neighbor | 70 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/architecture.ts contains 3 detected symbols, 2 imports, 1 export. |
| `src/outputs/dependency-graph.ts` | dependency-neighbor | 85 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/dependency-graph.ts contains 7 detected symbols, 2 imports, 2 exports. |
| `src/outputs/agents-md.ts` | dependency-neighbor | 159 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/agents-md.ts contains 31 detected symbols, 3 imports, 1 export. |
| `src/outputs/context-layers.ts` | dependency-neighbor | 66 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/context-layers.ts contains 3 detected symbols, 2 imports, 1 export. |
| `src/outputs/key-files.ts` | dependency-neighbor | 57 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/key-files.ts contains 2 detected symbols, 2 imports, 1 export. |
| `src/outputs/module-map.ts` | dependency-neighbor | 58 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/module-map.ts contains 2 detected symbols, 2 imports, 1 export. |
| `src/outputs/onboarding.ts` | dependency-neighbor | 60 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/onboarding.ts contains 2 detected symbols, 2 imports, 1 export. |
| `src/outputs/repo-summary.ts` | dependency-neighbor | 58 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/repo-summary.ts contains 1 detected symbol, 3 imports, 1 export. |
| `src/outputs/token-savings.ts` | dependency-neighbor | 59 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/token-savings.ts contains 1 detected symbol, 3 imports, 1 export. |
| `src/outputs/readiness.ts` | dependency-neighbor | 56 | direct importer of src/core/types.ts, direct importer of src/outputs/markdown.ts | src/outputs/readiness.ts contains 1 detected symbol, 2 imports, 1 export. |
...
| Bucket | Tokens | Files |
| --- | --- | --- |
| Directly relevant source files | 513 | `benchmarks/tasks/refactor-config-loader.json`, `code-agent-plusplus.config.example.yml`, `code-agent-plusplus.local.example.yml`, `assets/agent-context-code-layers.png`, `src/core/types.ts`, `src/outputs/markdown.ts` |
| Tests | 2,275 | `test/mcp.test.ts`, `test/analyzers.test.ts`, `test/token-savings.test.ts`, `test/readiness.test.ts`, `benchmarks/fixtures/small-ts-app/test/api/login.test.ts`, `benchmarks/fixtures/monorepo/packages/api/test/config.test.ts`, `benchmarks/fixtures/fastapi-app/tests/test_users.py`, `benchmarks/fixtures/react-app/src/auth/useAuthState.test.ts`, `benchmarks/fixtures/react-app/src/components/LoginStatus.test.tsx`, `benchmarks/fixtures/small-ts-app/test/auth/session.test.ts`, `benchmarks/fixtures/monorepo/packages/config/test/loader.test.ts`, `test/context-delta.test.ts`, `test/contract-validator.test.ts`, `test/execution-trace.test.ts`, `test/freshness.test.ts`, `test/loop-controller.test.ts`, `test/orchestrator.test.ts`, `test/policy-engine.test.ts`, `test/task-harness.test.ts`, `test/test-selector.test.ts`, `test/agents-md.test.ts`, `test/config.test.ts`, `test/retrievers.test.ts`, `test/writer.test.ts`, `test/cache.test.ts`, `test/impact.test.ts`, `test/task-context.test.ts`, `test/fixtures.test.ts`, `test/validator.test.ts`, `test/scanner.test.ts`, `test/snapshot.test.ts`, `test/benchmark.test.ts` |
| Dependency neighbors | 8,541 | `src/outputs/context-delta.ts`, `src/outputs/orchestrator.ts`, `src/outputs/execution-trace.ts`, `src/core/token-estimator.ts`, `src/outputs/task-harness.ts`, `src/outputs/task-run.ts`, `src/outputs/loop-controller.ts`, `src/outputs/policy-engine.ts`, `src/outputs/impact.ts`, `src/outputs/test-selector.ts`, `src/retrievers/index.ts`, `src/outputs/task-context.ts`, `src/core/freshness.ts`, `src/outputs/contract-validator.ts`, `src/benchmarks/benchmark.ts`, `src/outputs/rag.ts`, `src/core/context-builder.ts`, `src/outputs/writer.ts`, `src/outputs/architecture.ts`, `src/outputs/dependency-graph.ts`, `src/outputs/agents-md.ts`, `src/outputs/context-layers.ts`, `src/outputs/key-files.ts`, `src/outputs/module-map.ts`, `src/outputs/onboarding.ts`, `src/outputs/repo-summary.ts`, `src/outputs/token-savings.ts`, `src/outputs/readiness.ts`, `src/retrievers/static.ts`, `src/outputs/runtime-state.ts`, `src/core/cache.ts`, `src/core/scanner.ts`, `src/config/load-config.ts`, `src/core/indexer.ts`, `src/analyzers/python.ts`, `src/analyzers/javascript.ts`, `src/retrievers/ripgrep.ts`, `src/retrievers/types.ts`, `src/core/token-savings.ts`, `src/core/readiness.ts`, `src/core/validator.ts`, `src/analyzers/types.ts`, `src/outputs/contracts.ts`, `src/core/file-classifier.ts`, `src/analyzers/tree-sitter.ts`, `src/llm/provider.ts`, `src/core/summarizer.ts`, `src/core/graph.ts`, `src/core/ranker.ts`, `src/config/defaults.ts`, `src/core/path-utils.ts` |
| Config/docs | 38 | `code-agent-plusplus.config.yml` |
| Entrypoints | 627 | `src/mcp/server.ts`, `src/cli/index.ts` |
