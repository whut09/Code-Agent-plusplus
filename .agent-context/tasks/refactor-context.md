...
Type: refactor
Budget: 10,932 / 12,000 estimated tokens
...
| `test/loop-controller.test.ts` | test | 104 | direct importer of src/outputs/execution-trace.ts, shared API/refactor risk | test/loop-controller.test.ts contains 22 detected symbols, 10 imports, 0 exports. |
...
| `src/outputs/loop-controller.ts` | dependency-neighbor | 326 | direct importer of src/outputs/execution-trace.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/loop-controller.ts contains 67 detected symbols, 12 imports, 10 exports. |
...
Remaining budget: 1,068 estimated tokens
