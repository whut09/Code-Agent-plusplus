...
| --- | --- | --- | --- | --- |
| `src/integrations/opencode/sidecar.ts` | direct-source | 713 | lexical match: code, safely, shared API/refactor risk | src/integrations/opencode/sidecar.ts contains 136 detected symbols, 15 imports, 18 exports. |
...
| `test/opencode-launcher.test.ts` | test | 92 | lexical match: code, direct importer of src/integrations/opencode/sidecar.ts, shared API/refactor risk | test/opencode-launcher.test.ts contains 20 detected symbols, 12 imports, 0 exports. |
