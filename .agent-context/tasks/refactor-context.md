...
| `src/cli/index.ts` | entrypoint | 418 | lexical match: code, entrypoint, shared API/refactor risk | src/cli/index.ts contains 130 detected symbols, 35 imports, 0 exports. |
| `test/opencode-preset.test.ts` | test | 93 | lexical match: code, related test, shared API/refactor risk | test/opencode-preset.test.ts contains 20 detected symbols, 8 imports, 0 exports. |
...
| `src/cli/opencode-preset.ts` | dependency-neighbor | 368 | lexical match: code, direct dependency of test/opencode-preset.test.ts, shared API/refactor risk | src/cli/opencode-preset.ts contains 57 detected symbols, 5 imports, 16 exports. |
