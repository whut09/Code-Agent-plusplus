...
Type: refactor
Budget: 10,541 / 12,000 estimated tokens

## Read First
1. `benchmarks/tasks/refactor-config-loader.json` - lexical match: refactor
2. `src/outputs/markdown.ts` - lexical match: code, direct dependency of src/outputs/context-delta.ts; defines heading
3. `assets/agent-context-code-layers.png` - lexical match: code
4. `src/outputs/execution-trace.ts` - lexical match: code, direct importer of src/outputs/markdown.ts; defines ExecutionFinalState
5. `src/outputs/context-delta.ts` - lexical match: code, direct importer of src/outputs/markdown.ts; defines DeltaImpactLevel
6. `src/core/token-estimator.ts` - lexical match: code, shared API/refactor risk; defines estimateTokens
7. `src/cli/index.ts` - direct importer of src/outputs/execution-trace.ts, direct importer of src/outputs/context-delta.ts; defines program
8. `src/mcp/server.ts` - direct importer of src/outputs/context-delta.ts, direct importer of src/outputs/execution-trace.ts; defines repoContextMcpToolNames

## Then Inspect If Needed
- `test/context-delta.test.ts` - direct importer of src/outputs/context-delta.ts, related test
- `test/execution-trace.test.ts` - direct importer of src/outputs/execution-trace.ts, related test
- `test/policy-engine.test.ts` - direct importer of src/outputs/execution-trace.ts, shared API/refactor risk
...
| `src/outputs/markdown.ts` | direct-source | 68 | lexical match: code, direct dependency of src/outputs/context-delta.ts, direct dependency of src/outputs/execution-trace.ts, shared API/refactor risk | src/outputs/markdown.ts contains 8 detected symbols, 0 imports, 5 exports. |
...
| `src/outputs/execution-trace.ts` | direct-source | 322 | lexical match: code, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/execution-trace.ts contains 49 detected symbols, 5 imports, 18 exports. |
...
| `src/cli/index.ts` | entrypoint | 265 | direct importer of src/outputs/execution-trace.ts, direct importer of src/outputs/context-delta.ts, direct importer of src/core/token-estimator.ts, entrypoint, shared API/refactor risk | src/cli/index.ts contains 88 detected symbols, 28 imports, 0 exports. |
...
| `test/execution-trace.test.ts` | test | 78 | direct importer of src/outputs/execution-trace.ts, related test, shared API/refactor risk | test/execution-trace.test.ts contains 15 detected symbols, 9 imports, 0 exports. |
| `test/policy-engine.test.ts` | test | 98 | direct importer of src/outputs/execution-trace.ts, shared API/refactor risk | test/policy-engine.test.ts contains 21 detected symbols, 10 imports, 0 exports. |
...
| `test/loop-controller.test.ts` | test | 79 | shared API/refactor risk | test/loop-controller.test.ts contains 12 detected symbols, 9 imports, 0 exports. |
...
| `src/outputs/task-run.ts` | dependency-neighbor | 196 | direct importer of src/outputs/markdown.ts, direct importer of src/outputs/execution-trace.ts, shared API/refactor risk | src/outputs/task-run.ts contains 41 detected symbols, 9 imports, 4 exports. |
| `src/outputs/policy-engine.ts` | dependency-neighbor | 294 | direct importer of src/outputs/execution-trace.ts, direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/policy-engine.ts contains 55 detected symbols, 8 imports, 8 exports. |
...
| `src/core/types.ts` | dependency-neighbor | 297 | direct dependency of src/core/token-estimator.ts, direct dependency of src/outputs/context-delta.ts, shared API/refactor risk | src/core/types.ts contains 35 detected symbols, 0 imports, 35 exports. |
...
| `src/outputs/agents-md.ts` | dependency-neighbor | 159 | direct importer of src/core/token-estimator.ts, direct importer of src/outputs/markdown.ts | src/outputs/agents-md.ts contains 31 detected symbols, 3 imports, 1 export. |
...
| `src/outputs/contract-validator.ts` | dependency-neighbor | 327 | direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/contract-validator.ts contains 65 detected symbols, 6 imports, 5 exports. |
| `src/outputs/loop-controller.ts` | dependency-neighbor | 252 | direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/outputs/loop-controller.ts contains 46 detected symbols, 10 imports, 10 exports. |
...
| `src/benchmarks/benchmark.ts` | dependency-neighbor | 452 | direct importer of src/outputs/markdown.ts, shared API/refactor risk | src/benchmarks/benchmark.ts contains 90 detected symbols, 7 imports, 11 exports. |
...
| `src/core/cache.ts` | dependency-neighbor | 188 | direct importer of src/core/token-estimator.ts, shared API/refactor risk | src/core/cache.ts contains 34 detected symbols, 5 imports, 4 exports. |
...
| `src/core/git.ts` | dependency-neighbor | 78 | direct dependency of src/outputs/context-delta.ts | src/core/git.ts contains 8 detected symbols, 1 import, 2 exports. |
...
| Bucket | Tokens | Files |
| --- | --- | --- |
| Directly relevant source files | 902 | `benchmarks/tasks/refactor-config-loader.json`, `src/outputs/markdown.ts`, `assets/agent-context-code-layers.png`, `src/outputs/execution-trace.ts`, `src/outputs/context-delta.ts`, `src/core/token-estimator.ts` |
| Tests | 2,127 | `test/context-delta.test.ts`, `test/execution-trace.test.ts`, `test/policy-engine.test.ts`, `benchmarks/fixtures/small-ts-app/test/api/login.test.ts`, `benchmarks/fixtures/monorepo/packages/api/test/config.test.ts`, `benchmarks/fixtures/fastapi-app/tests/test_users.py`, `benchmarks/fixtures/react-app/src/auth/useAuthState.test.ts`, `benchmarks/fixtures/react-app/src/components/LoginStatus.test.tsx`, `benchmarks/fixtures/small-ts-app/test/auth/session.test.ts`, `benchmarks/fixtures/monorepo/packages/config/test/loader.test.ts`, `test/contract-validator.test.ts`, `test/freshness.test.ts`, `test/loop-controller.test.ts`, `test/task-harness.test.ts`, `test/test-selector.test.ts`, `test/agents-md.test.ts`, `test/config.test.ts`, `test/mcp.test.ts`, `test/retrievers.test.ts`, `test/writer.test.ts`, `test/analyzers.test.ts`, `test/cache.test.ts`, `test/impact.test.ts`, `test/task-context.test.ts`, `test/fixtures.test.ts`, `test/token-savings.test.ts`, `test/readiness.test.ts`, `test/validator.test.ts`, `test/scanner.test.ts`, `test/snapshot.test.ts`, `test/benchmark.test.ts` |
| Dependency neighbors | 6,247 | `src/outputs/task-run.ts`, `src/outputs/policy-engine.ts`, `src/outputs/rag.ts`, `src/core/types.ts`, `src/outputs/task-context.ts`, `src/outputs/agents-md.ts`, `src/core/freshness.ts`, `src/outputs/task-harness.ts`, `src/outputs/contract-validator.ts`, `src/outputs/loop-controller.ts`, `src/core/context-builder.ts`, `src/outputs/writer.ts`, `src/outputs/impact.ts`, `src/outputs/test-selector.ts`, `src/benchmarks/benchmark.ts`, `src/retrievers/index.ts`, `src/core/cache.ts`, `src/core/scanner.ts`, `src/core/token-savings.ts`, `src/outputs/architecture.ts`, `src/outputs/dependency-graph.ts`, `src/outputs/context-layers.ts`, `src/outputs/key-files.ts`, `src/outputs/module-map.ts`, `src/outputs/onboarding.ts`, `src/outputs/repo-summary.ts`, `src/outputs/token-savings.ts`, `src/outputs/readiness.ts`, `src/core/git.ts`, `src/retrievers/static.ts`, `src/core/path-utils.ts`, `src/retrievers/types.ts`, `src/config/load-config.ts`, `src/core/indexer.ts`, `src/analyzers/python.ts`, `src/analyzers/javascript.ts`, `src/retrievers/ripgrep.ts` |
...
| Entrypoints | 589 | `src/cli/index.ts`, `src/mcp/server.ts` |

Remaining budget: 1,459 estimated tokens
