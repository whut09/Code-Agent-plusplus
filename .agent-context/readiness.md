...
| --- | --- | --- | --- |
| structure | 97/100 | Entrypoint: src/cli/index.ts; Entrypoint: src/mcp/server.ts; 25 modules detected.; 477 dependency edges detected.; 70% of files have medium/high-confidence analysis. | none |
...
| task-context | 100/100 | 2084 code symbols extracted.; Internal dependency neighbors are available.; 126 files include analysis evidence. | none |
