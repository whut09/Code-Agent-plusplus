...
| --- | --- | --- | --- |
| operational | 99/100 | Entrypoint: src/cli/index.ts; Entrypoint: src/mcp/server.ts; 28 modules detected.; 721 dependency edges detected.; 62% of files have medium/high-confidence analysis.; Run command: npm run dev; Lint command: npm run lint; Lint command: npm run format; Lint command: npm run format:check; Lint command: npm run prepublishOnly; Typecheck command: npm run build; Typecheck command: npm run check; Test/check command: npm run test; 58 test files detected.; CI: .github/workflows/ci.yml | none |
| context-quality | 99/100 | README documentation detected.; Architecture documentation detected.; 3366 code symbols extracted.; Internal dependency neighbors are available.; 161 files include analysis evidence.; Entrypoint: src/cli/index.ts; Entrypoint: src/mcp/server.ts; 28 modules detected.; 721 dependency edges detected.; 62% of files have medium/high-confidence analysis. | none |
| agent-safety | 100/100 | Environment example: .env.example; CI workflow: .github/workflows/ci.yml; No database signals detected; migration guidance is not applicable.; Test/check command: npm run test; 58 test files detected.; CI: .github/workflows/ci.yml; Run command: npm run dev; Lint command: npm run lint; Lint command: npm run format; Lint command: npm run format:check; Lint command: npm run prepublishOnly; Typecheck command: npm run build; Typecheck command: npm run check | none |
...
| --- | --- | --- | --- |
| structure | 96/100 | Entrypoint: src/cli/index.ts; Entrypoint: src/mcp/server.ts; 28 modules detected.; 721 dependency edges detected.; 62% of files have medium/high-confidence analysis. | none |
...
| tests | 100/100 | Test/check command: npm run test; 58 test files detected.; CI: .github/workflows/ci.yml | none |
| architecture | 100/100 | README documentation detected.; Architecture documentation detected. | none |
| task-context | 100/100 | 3366 code symbols extracted.; Internal dependency neighbors are available.; 161 files include analysis evidence. | none |
