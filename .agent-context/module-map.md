...
| --- | --- | --- | --- | --- |
| outputs | 20 | 906 | `core` | outputs contains 20 files and depends on core. |
| test | 22 | 749 | `analyzers`, `benchmarks`, `cli`, `config`, `core`, `mcp`, `outputs`, `retrievers` | test contains 22 files and depends on analyzers, benchmarks, cli, config, core, mcp, outputs, retrievers. |
| core | 15 | 731 | `analyzers`, `config`, `llm` | core contains 15 files and depends on analyzers, config, llm. |
