...
| --- | --- | --- | --- | --- |
| core | 15 | 667 | `analyzers`, `config`, `llm` | core contains 15 files and depends on analyzers, config, llm. |
| test | 22 | 475 | `analyzers`, `config`, `core`, `outputs` | test contains 22 files and depends on analyzers, config, core, outputs. |
