...
| --- | --- | --- | --- | --- |
| outputs | 30 | 1635 | `core` | outputs contains 30 files and depends on core. |
| test | 33 | 1193 | `analyzers`, `benchmarks`, `cli`, `config`, `core`, `mcp`, `outputs`, `retrievers` | test contains 33 files and depends on analyzers, benchmarks, cli, config, core, mcp, outputs, retrievers. |
