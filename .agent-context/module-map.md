...
| test | 35 | 1262 | `analyzers`, `benchmarks`, `cli`, `config`, `core`, `harness`, `integrations`, `mcp`, `outputs`, `retrievers` | test contains 35 files and depends on analyzers, benchmarks, cli, config, core, harness, integrations, mcp, outputs, retrievers. |
| core | 18 | 941 | `analyzers`, `config`, `llm`, `outputs` | core contains 18 files and depends on analyzers, config, llm, outputs. |
| harness | 9 | 654 | `core`, `outputs`, `sandbox` | harness contains 9 files and depends on core, outputs, sandbox. |
...
| cli | 2 | 116 | `benchmarks`, `config`, `core`, `harness`, `integrations`, `outputs`, `retrievers` | cli contains 2 files and depends on benchmarks, config, core, harness, integrations, outputs, retrievers. |
...
| mcp | 1 | 91 | `core`, `harness`, `outputs`, `retrievers` | mcp contains 1 file and depends on core, harness, outputs, retrievers. |
| benchmarks/fixtures/monorepo/packages/config | 4 | 79 | none | benchmarks/fixtures/monorepo/packages/config contains 4 files. |
| integrations | 1 | 75 | `core`, `retrievers` | integrations contains 1 file and depends on core, retrievers. |
