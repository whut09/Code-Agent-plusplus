...
| core | 16 | 790 | `analyzers`, `config`, `llm` | core contains 16 files and depends on analyzers, config, llm. |
| test | 23 | 789 | `analyzers`, `benchmarks`, `cli`, `config`, `core`, `mcp`, `outputs`, `retrievers` | test contains 23 files and depends on analyzers, benchmarks, cli, config, core, mcp, outputs, retrievers. |
