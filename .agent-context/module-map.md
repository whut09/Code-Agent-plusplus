...
| --- | --- | --- | --- | --- |
| core | 15 | 671 | `analyzers`, `config`, `llm` | core contains 15 files and depends on analyzers, config, llm. |
| test | 23 | 518 | `analyzers`, `config`, `core`, `outputs` | test contains 23 files and depends on analyzers, config, core, outputs. |
