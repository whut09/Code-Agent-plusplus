...
Actual context pack (chars_approx): 99,060 tokens

## Selection
- Selected files: 80
- Total scanned files: 227
...
- `.agent-context/rag/documents.jsonl`: 75,853 tokens
