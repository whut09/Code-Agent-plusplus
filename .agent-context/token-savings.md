...
Actual context pack (chars_approx): 78,103 tokens

## Selection
- Selected files: 80
- Total scanned files: 172
- Token budget: 80,000
...
## Estimated Tokens
- Original repo: 1,551,463 tokens (chars_approx)
- Estimated context pack: 17,189 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 78,103 tokens
...
- `.agent-context/key-files.md`: 2,649 tokens
...
- `.agent-context/tasks/refactor-context.md`: 5,194 tokens
- `.agent-context/rag/README.md`: 167 tokens
- `.agent-context/rag/documents.jsonl`: 60,042 tokens
