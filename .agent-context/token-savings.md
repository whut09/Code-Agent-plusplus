...
Actual context pack (chars_approx): 100,538 tokens

## Selection
- Selected files: 80
- Total scanned files: 254
...
## Estimated Tokens
- Original repo: 1,693,440 tokens (chars_approx)
- Estimated context pack: 20,969 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 100,538 tokens
...
- `.agent-context/repo-summary.md`: 861 tokens
- `.agent-context/context-layers.md`: 677 tokens
- `.agent-context/key-files.md`: 2,778 tokens
...
- `.agent-context/tasks/refactor-context.md`: 4,799 tokens
- `.agent-context/rag/README.md`: 165 tokens
- `.agent-context/rag/documents.jsonl`: 77,051 tokens
