...
Actual context pack (chars_approx): 91,561 tokens

## Selection
- Selected files: 80
- Total scanned files: 194
...
- `.agent-context/repo-summary.md`: 783 tokens
- `.agent-context/context-layers.md`: 677 tokens
- `.agent-context/key-files.md`: 2,664 tokens
...
- `.agent-context/tasks/bugfix-context.md`: 4,415 tokens
- `.agent-context/tasks/feature-context.md`: 2,389 tokens
- `.agent-context/tasks/refactor-context.md`: 5,138 tokens
- `.agent-context/rag/README.md`: 165 tokens
- `.agent-context/rag/documents.jsonl`: 69,590 tokens
