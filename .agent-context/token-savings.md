...
Actual context pack (chars_approx): 99,204 tokens

## Selection
- Selected files: 80
- Total scanned files: 252
...
## Estimated Tokens
- Original repo: 1,690,310 tokens (chars_approx)
- Estimated context pack: 20,963 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 99,204 tokens
...
- `.agent-context/key-files.md`: 2,765 tokens
- `.agent-context/module-map.md`: 872 tokens
- `.agent-context/architecture.md`: 430 tokens
...
- `.agent-context/rag/documents.jsonl`: 75,906 tokens
