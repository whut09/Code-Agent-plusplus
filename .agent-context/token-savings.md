...
Actual context pack (chars_approx): 67,347 tokens

## Selection
- Selected files: 80
- Total scanned files: 157
- Token budget: 80,000
...
## Estimated Tokens
- Original repo: 1,511,840 tokens (chars_approx)
- Estimated context pack: 14,502 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 67,347 tokens
Scope: Generated Markdown, Mermaid, and RAG JSONL files; excludes machine-readable indexes and the token report itself.

- `.agent-context/AGENTS.generated.md`: 691 tokens
- `AGENTS.md`: 786 tokens
- `.agent-context/repo-summary.md`: 745 tokens
- `.agent-context/context-layers.md`: 519 tokens
- `.agent-context/key-files.md`: 2,670 tokens
...
- `.agent-context/tasks/bugfix-context.md`: 1,797 tokens
- `.agent-context/tasks/feature-context.md`: 1,627 tokens
- `.agent-context/tasks/refactor-context.md`: 4,491 tokens
- `.agent-context/rag/README.md`: 167 tokens
- `.agent-context/rag/documents.jsonl`: 51,534 tokens
