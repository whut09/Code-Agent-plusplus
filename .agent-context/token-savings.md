...
Actual context pack (chars_approx): 74,919 tokens

## Selection
- Selected files: 80
- Total scanned files: 166
- Token budget: 80,000
...
## Estimated Tokens
- Original repo: 1,545,416 tokens (chars_approx)
- Estimated context pack: 16,634 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 74,919 tokens
...
- `.agent-context/repo-summary.md`: 770 tokens
- `.agent-context/context-layers.md`: 677 tokens
- `.agent-context/key-files.md`: 2,642 tokens
- `.agent-context/module-map.md`: 732 tokens
- `.agent-context/architecture.md`: 406 tokens
- `.agent-context/dependency-graph.md`: 645 tokens
- `.agent-context/graphs/dependencies.mmd`: 392 tokens
...
- `.agent-context/tasks/refactor-context.md`: 4,868 tokens
- `.agent-context/rag/README.md`: 167 tokens
- `.agent-context/rag/documents.jsonl`: 57,302 tokens
