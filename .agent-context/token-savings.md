...
Original repo (estimated, chars_approx): 1,652,694 tokens
Estimated context pack (chars_approx): 19,754 tokens
Compression: 17x
Token budget: 100,000 (within budget)
Actual context pack (chars_approx): 95,934 tokens

## Selection
- Selected files: 80
- Total scanned files: 200
...
## Estimated Tokens
- Original repo: 1,652,694 tokens (chars_approx)
- Estimated context pack: 19,754 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 95,934 tokens
...
- `.agent-context/dependency-graph.md`: 786 tokens
...
- `.agent-context/tasks/bugfix-context.md`: 5,330 tokens
- `.agent-context/tasks/feature-context.md`: 3,330 tokens
- `.agent-context/tasks/refactor-context.md`: 4,916 tokens
- `.agent-context/rag/README.md`: 165 tokens
- `.agent-context/rag/documents.jsonl`: 72,022 tokens
