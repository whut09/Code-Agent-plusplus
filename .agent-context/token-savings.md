...
Actual context pack (chars_approx): 86,404 tokens

## Selection
- Selected files: 80
- Total scanned files: 188
- Token budget: 90,000
...
## Estimated Tokens
- Original repo: 1,615,098 tokens (chars_approx)
- Estimated context pack: 18,413 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 86,404 tokens
Scope: Generated Markdown, Mermaid, and RAG JSONL files; excludes machine-readable indexes and the token report itself.

- `.agent-context/AGENTS.generated.md`: 1,071 tokens
- `AGENTS.md`: 1,166 tokens
- `.agent-context/repo-summary.md`: 784 tokens
...
- `.agent-context/tasks/bugfix-context.md`: 2,291 tokens
- `.agent-context/tasks/feature-context.md`: 2,366 tokens
- `.agent-context/tasks/refactor-context.md`: 5,816 tokens
- `.agent-context/rag/README.md`: 165 tokens
- `.agent-context/rag/documents.jsonl`: 66,154 tokens
