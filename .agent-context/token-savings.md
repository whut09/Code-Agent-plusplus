...
Actual context pack (chars_approx): 84,228 tokens
...
## Estimated Tokens
- Original repo: 1,590,720 tokens (chars_approx)
- Estimated context pack: 18,014 tokens (chars_approx)

## Actual Generated Output
Tokenizer: chars_approx
Actual output: 84,228 tokens
...
- `.agent-context/tasks/refactor-context.md`: 5,907 tokens
- `.agent-context/rag/README.md`: 167 tokens
- `.agent-context/rag/documents.jsonl`: 64,124 tokens
